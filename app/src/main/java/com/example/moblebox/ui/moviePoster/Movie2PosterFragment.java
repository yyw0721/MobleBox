...
public class Movie2PosterFragment extends Fragment {
    ...
    public Movie2PosterFragment(Map<String, String> map){
        this.movieMap = map;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_movie2_poster, container, false);

        activity = (MainActivity)getActivity();
        img_movie2 = (TextView)view.findViewById(R.id.tv_movie2_poster);
            ...
            new Thread(){
                Handler handler = new Handler(Looper.getMainLooper()){
                    ...
                    public void handleMessage(@NonNull Message msg) {
                        ...
                        if (msg.what == 10){
                            Glide.with(Movie2PosterFragment.this).load(arrayList.get(1))
                                    .into(new SimpleTarget<Drawable>() {
                                        ...
                                        public void onResourceReady(
                                            ...
                                            img_movie2.setBackground(resource);
                                        }
                                    });
                            img_movie2.setText(String.valueOf(arrayList.get(0)));
                            img_movie2.setTextColor(Color.TRANSPARENT);
                        }
                    }
                };
                @Override
        ...
        img_movie2.setOnClickListener(new View.OnClickListener() {
            @Override
