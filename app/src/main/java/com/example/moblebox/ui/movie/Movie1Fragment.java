...
public class Movie1Fragment extends Fragment {
    ...
    public static Movie1Fragment newInstance(){
        return new Movie1Fragment();
    }

    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {

        view = inflater.inflate(R.layout.fragment_movie1, container, false);

        iv_movie1 = (ImageView)view.findViewById(R.id.movie1_iv_movie1);
        tv_movieNm = (TextView)view.findViewById(R.id.movie1_tv_0);
        tv_subNm = (TextView)view.findViewById(R.id.movie1_tv_1);
        tv_year = (TextView)view.findViewById(R.id.movie1_tv_1_sub);
        tv_plot = (TextView)view.findViewById(R.id.movie1_tv_3);
        tv_view1 = (TextView)view.findViewById(R.id.movie1_tv_view1);
        tv_view1.setVisibility(View.GONE);

        btn_close = (Button)view.findViewById(R.id.movie1_btn_close);
        btn_close.setVisibility(View.GONE);

        btn_open = (Button)view.findViewById(R.id.movie1_btn_add);

        fab = view.findViewById(R.id.fab_abo);

        myScrollView = view.findViewById(R.id.scrollView_abo);
                ...
                Handler handler = new Handler(Looper.getMainLooper()){
                    ...
                    public void handleMessage(@NonNull Message msg) {
                        ...
                        if(msg.what == 10){
                            ...
                            Glide.with(Movie1Fragment.this).load(arrayList.get(0))
                                    .into(iv_movie1);
                        }
                    }
                };
